 ...
 * @param {Object.<string, function> | function(object, string, object?)} mapCallback A map of node types to callbacks, or a single callback that will be called for all node types
 * @param {object} [o]
 ...
 */
export default function map (node, mapCallback, o) {
	const callback = getTransformMapCallback(mapCallback);
	return transform(
		node,
